...
echo Historia AI - Gemini Tier 1 multilingual index
echo Existing progress will be preserved. Keep this window open.
echo.

pushd backend
.venv\Scripts\python.exe -m app.scripts.ingest --resume --batch-size 64 --batch-delay-seconds 2
