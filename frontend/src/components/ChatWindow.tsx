...
export function ChatWindow() {
  ...
  return (
    <div className="flex flex-col flex-1 min-h-0">
      <div className="flex-1 overflow-y-auto px-4 sm:px-6 py-6 flex flex-col gap-4">
        {messages.length === 0 ? (
          <div className="m-auto text-center max-w-md">
            ...
            <p className="mt-1.5 text-sm text-white/60" dir="rtl">
      ...
      <form onSubmit={handleSubmit} className="border-t border-white/10 bg-black/10 p-3 sm:p-4">
        <div className="flex items-center gap-2 rounded-2xl border border-white/10 bg-black/20 px-2 py-1.5 focus-within:border-[var(--accent)] transition-colors">
          <input
            value={input}
